...
A token is used give owner authorize access to a network service. 

- [ ] What steps can you take in your web apps to keep your data secure?

Scanning web apps for vulnerabilities and backing up your data

- [ ] Describe how web servers work.

A web server processess incoming network requests over HTTP and serveral other related protocols. Main function is to store, process and deliver web pages to client.
